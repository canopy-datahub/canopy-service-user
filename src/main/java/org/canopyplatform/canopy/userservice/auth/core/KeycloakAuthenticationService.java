package org.canopyplatform.canopy.userservice.auth.core;

import org.canopyplatform.canopy.userservice.auth.AuthCapability;
import org.canopyplatform.canopy.userservice.auth.UserAuthenticationException;
import org.canopyplatform.canopy.userservice.auth.UserAuthorizationException;
import org.canopyplatform.canopy.userservice.auth.AccessRole;
import org.canopyplatform.canopy.userservice.auth.AuthLookupStatusRepository;
import org.canopyplatform.canopy.userservice.auth.AuthRole;
import org.canopyplatform.canopy.userservice.auth.AuthUser;
import org.canopyplatform.canopy.userservice.auth.AuthUserRepository;
 ...
 *     Integer userId = authenticationService.checkCapability(jwt, "user.admin.list");
 *     // ... admin only logic
 * }
 * }
 * </pre>
